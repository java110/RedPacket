 ...
 */
@Controller
public class WIndexPacketController extends BaseController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping({"/WIndexPacketController.indexPage"})
	   public ModelAndView indexPage(HttpServletRequest request, HttpServletResponse response)
		...
		//查询商家产品
	    ModelAndView view = new ModelAndView("/wIndexPacket.jsp", this.viewData);
