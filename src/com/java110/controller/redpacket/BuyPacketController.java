 ...
 */
@Controller
public class BuyPacketController extends BaseController {
	// 用户服务
	 ...
	 * @throws Exception
	 */
	@RequestMapping({"/BuyPacketController.indexPage"})
	 ...
	 * @throws Exception
	 */
	@RequestMapping({"/BuyPacketController.Recharge"})
	 ...
	 * @throws Exception
	 */
	@RequestMapping({"/BuyPacketController.ReturnPayController"})
	...
	public String builtParam(String out_trade_no,String monery,String name){
		 ...
		 String param = "WIDout_trade_no="+out_trade_no+"&WIDsubject=金币购买&WIDprice="+String.valueOf(monery)
	        ...
	        sbHtml.append("<html><meta charset=\"UTF-8\"><title></title><body><form id=\"payRequest\" name=\"payRequest\" action=\"http://www.java110.com/Java110Pay/services/PayServlet\"" +
	            ...
	            sbHtml.append("<input type=\"hidden\" name=\"returnPayUrl\" value=\""+Global.DOMAIN+"/BuyPacketController.ReturnPayController\"/>");
