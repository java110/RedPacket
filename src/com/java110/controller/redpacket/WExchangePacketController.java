 ...
 */
@Controller
public class WExchangePacketController extends BaseController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping({"/WExchangePacketController.indexPage"})
	   public ModelAndView indexPage(HttpServletRequest request, HttpServletResponse response)
	    ...
	    ModelAndView view = new ModelAndView("/wExchangePacket.jsp", this.viewData);
	  //查询用户账户信息
	 ...
	 * @throws Exception
	 */
	@RequestMapping({"/WExchangePacketController.exchangeMoney"})
