 ...
 */
@Controller
public class GetPacketController extends BaseController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping( { "/GetPacketController.indexPage" })
	public ModelAndView indexPage(HttpServletRequest request,
		...
		ModelAndView view = new ModelAndView("/getPacket.jsp", this.viewData);
		// 获取商家信息
	 ...
	 * @throws Exception
	 */
	@RequestMapping( { "/GetPacketController.getRedPacket" })
