...
<html>
	<head>
		...
		<script type="text/javascript" src="${WEBINFO.STATIC_DOMAIN }/RedJs/wIndexPacket.js" ></script>
	</head>
	<body>
		...
		<div class="red_main">
			<div class="red_main_pic">
				<a href="${WEBINFO.DOMAIN }/WSendPacketController.indexPage">
				...
				<a href="${WEBINFO.DOMAIN }/WBuyPacketController.indexPage">
					<img src="${WEBINFO.IMG_DOMAIN }/RedImg/indexPackage_04.gif" alt="包红包" />
				</a>
				<a href="${WEBINFO.DOMAIN }/WExchangePacketController.indexPage">
